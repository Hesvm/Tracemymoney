...
export function SettingsModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-[#2f333b]/14 px-3 sm:px-4 sm:py-10 backdrop-blur-[2px]"
        ...
        >
          <motion.section
            ...
            className="flex sm:max-h-[calc(100vh-80px)] w-full sm:w-[420px] sm:max-w-[calc(100vw-32px)] flex-col overflow-hidden rounded-[32px] sm:rounded-[34px] bg-[#fbfaf7] shadow-[0_30px_80px_rgba(76,74,68,0.2),0_1px_0_rgba(255,255,255,0.85)_inset]"
