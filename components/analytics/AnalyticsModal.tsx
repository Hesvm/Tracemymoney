      ...
      {open && (
        ...
        >
          ...
          <motion.section
            ...
            className="relative z-10 flex h-[88vh] w-[92vw] max-w-[1380px] flex-col overflow-hidden rounded-[36px] bg-[#fbfaf7] shadow-[0_34px_90px_rgba(76,74,68,0.22),0_2px_0_rgba(255,255,255,0.82)_inset]"
